...
.box ul li { width:350px; height:260px; display: inline-block; margin:10px; border:1px solid #e6e6e6; list-style:none; }
.box ul li a{ display: block ;height: 100%;width: 100%}
